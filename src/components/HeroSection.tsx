  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center pt-16 pb-10 overflow-hidden px-4 bg-[#0a0a0c]">
      <div className="container relative z-10 max-w-7xl flex flex-col items-center">
        ...
        {/* --- ЭКРАН 1: ГЛАВНЫЙ (КРУПНАЯ СЕТКА ВОССТАНОВЛЕНА) --- */}
        ...
        {/* --- ЭКРАН 2: ЛИНЕЙКА СТИЛЕЙ (КОМПАКТНАЯ ВОССТАНОВЛЕНА) --- */}
        ...
        {/* --- ЭКРАН 3: КАК СДЕЛАТЬ СТИКЕР (SEO ИСПРАВЛЕНИЯ ВОССТАНОВЛЕНЫ) --- */}
        <div className="mt-12 mb-16 w-full max-w-6xl mx-auto px-6">
          <ScrollReveal>
            <div className="text-center mb-10">
              ...
              {/* Строка описания в одну линию на десктопе */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { 
                step: "01", 
                title: "Загрузи фото", 
                // Описание без "наш", 3 строчки ровно
        ...
        {/* --- ЭКРАН 4: ГЕНЕРАТОР (ПОЛНОСТЬЮ ОБНОВЛЁН) --- */}
        <div id="generator" className="mt-16 mb-20 w-full max-w-6xl mx-auto px-4 text-center">
          <ScrollReveal>
            <h2 className="text-4xl md:text-6xl font-black uppercase text-white mb-6">
              Создать <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">стикер</span>
            </h2>
          ...
          {/* ИНТЕРАКТИВНЫЙ БЛОК ГЕНЕРАТОРА (ВОССТАНОВЛЕН ИСПРАВЛЕННЫЙ) */}
          <ScrollReveal delay={200}>
          ...
          {/* КНОПКА СОЗДАТЬ (ПЕРЕИМЕНОВАНА ВОССТАНОВЛЕНА) */}
          <ScrollReveal delay={400}>
